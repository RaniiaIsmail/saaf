...
// ─── TransactionType محدثة تدعم بيانات الباك ───
...
// ─── transactionData محدثة تتوافق مع TransactionType الجديدة ───
export const transactionData: TransactionType[] = [
  {
    id: '#TZ2540',
    user: { name: 'Michael A. Miner', image: 'assets/images/users/avatar-2.jpg' },
  ...
  {
    id: '#TZ3924',
    user: { name: 'Theresa T. Brose', image: 'assets/images/users/avatar-3.jpg' },
  ...
  {
    id: '#TZ5032',
    user: { name: 'Walter L. Calab', image: 'assets/images/users/avatar-4.jpg' },
  ...
  {
    id: '#TZ1695',
    user: { name: 'Olive Mize', image: 'assets/images/users/avatar-5.jpg' },
  ...
  {
    id: '#TZ8473',
    user: { name: 'Christa Sardina', image: 'assets/images/users/avatar-6.jpg' },
  ...
  {
    id: '#TZ2150',
    user: { name: 'Darren Rivera', image: 'assets/images/users/avatar-7.jpg' },
    agentName: 'Darren Rivera',
    purchaseDate: '15 Mar, ' + currentYear,
    amount: 25671,
    type: 'master-distribution',
    status: 'succeeded',
    investedProperty: '',
    walletId: '',
    userId: '',
